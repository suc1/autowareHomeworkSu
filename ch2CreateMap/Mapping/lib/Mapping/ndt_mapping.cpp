...
static double max_scan_range = 100.0;
static double min_add_scan_shift = 5.0;
...
static void points_callback(const sensor_msgs::PointCloud2::ConstPtr& input)
{
  ...
  if (_method_type == MethodType::PCL_GENERIC)
  {
    ndt.align(*output_cloud, init_guess);//note-tianyu 由此进入正式的ndt算法运算
